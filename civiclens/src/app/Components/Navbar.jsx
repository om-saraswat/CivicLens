...
export default function Navbar() {
  ...
  return (
    <nav className="w-full flex justify-between items-center px-6 py-3 bg-black text-white shadow-lg z-50">
      {/* Left: Logo and Title */}
      <div className="flex items-center gap-3">
        <img src="/logo.png" alt="Org Logo" className="h-9 w-9 rounded-xl shadow-sm" />
        <span className="text-2xl font-extrabold tracking-wide">Civic AI Agent</span>
      </div>
